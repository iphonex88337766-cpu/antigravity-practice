/**
 * Playground — Duplicate of Index with puppy interaction.
 * Right-eye close → puppy appears on outer right side of face.
 */
    ...
    <div className="relative h-screen w-screen overflow-hidden bg-transparent">
      ...
      <div className="absolute inset-0">
        ...
        >
          ...
          {/* Puppy overlay — positioned relative to the video container */}
      ...
      {/* ── AVATAR OVERLAY — kept for structure ── */}
      <div
