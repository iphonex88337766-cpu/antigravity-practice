...
const Index = () => {
  ...
  return (
    <div className="relative flex h-[100dvh] w-screen flex-col lg:block bg-black overflow-hidden text-white pattern-dots pattern-slate-900 pattern-size-4 pattern-opacity-20 p-4 lg:p-0 gap-4 lg:gap-0">
      ...
      <div
        className="order-2 shrink-0 h-[35vh] w-full lg:w-[420px] lg:h-[420px]  lg:absolute z-50 lg:right-12 lg:bottom-0 lg:translate-x-32 lg:-translate-y-8 lg:w-[800px] lg:h-[800px] relative flex items-center justify-center z-30 lg:z-50 pointer-events-none transition-transform duration-300 overflow-visible"
      >
